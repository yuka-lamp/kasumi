...
<section id="about" class="wrap">
  <div class="sec">
    <div class="contant">
      ...
      <div class="txt-wrap">
        <h2 class="serif">コンセプト内容が<br>入ります</h2>
...
<section id="plan" class="wrap">
  <div class="sec">
    <div class="content">
      <a class="flex" href="<?php echo $home ?>/plan#plan01">
        <div class="img-wrap">
        ...
        <div class="txt-wrap">
          <h2 class="serif">武将プラン<span class="eng upper">busho plan</span></h2>
          <p class="price serif">¥10,000~</p>
          <p>サンプルテキストサンプルテキストサンプルテキストサンプルテキストサンプルテキストサンプルテキストサンプルテキストサンプルテキスト</p>
        </div>
      </a>
    </div>
    <div class="content">
      <a  class="flex" href="<?php echo $home ?>/plan#plan02">
        <div class="img-wrap">
...
<section id="flow" class="wrap">
  <div class="sec">
    ...
    <div class="txt-wrap">
      ...
      <p>サンプルテキストサンプルテキストサンプルテキストサンプルテキストサンプルテキストサンプルテキ</p>
      <ul>
        <li>
          <div class="img-wrap">
            <img src="<?php echo $wp_url ?>/lib/images/top/num_01.png" alt="">
          </div>
          <p class="serif">WEB予約 / 電話予約</p>
        </li>
        <li>
          <div class="img-wrap">
      ...
      <div class="btn01">
        <a class="eng" href="<?php echo $home ?>/flow">read more
        </a>
      </div>
    </div>
  </div>
